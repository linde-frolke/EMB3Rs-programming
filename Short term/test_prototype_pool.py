...
gmin={'gmin':np.zeros((settings.nr_of_h, len(agent_ids['agent_ids'])))}
gmax={'gmax':np.array([[1,2,0,5],[3,4,0,4],[1,5,0,3],[0,0,0,0],[1,1,0,1],[2,3,0,1],[4,2,0,5],[3,4,0,4],[1,5,0,3],
              [0,0,0,0],[1,1,0,1],[2,3,0,1]])}
lmin={'lmin':np.zeros((settings.nr_of_h, len(agent_ids['agent_ids'])))}
lmax={'lmax':np.array([[2,2,1,0],[2,1,0,0],[1,2,1,0],[3,0,2,0],[1,1,4,0],[2,3,3,0],[4,2,1,0],[3,4,2,0],[1,5,3,0],
              [0,0,5,0],[1,1,3,0],[2,3,1,0]])}
cost={'cost':np.array([[24,25,45,30],[31,24,0,24],[18,19,0,32],[0,0,0,0],[20,25,0,18],[25,31,0,19],[24,27,0,22],[32,31,0,19],
               [15,25,0,31],[0,0,0,0],[19,20,0,21],[22,33,0,17]])}
util={'util':np.array([[40,42,35,25],[45,50,40,0],[55,36,45,0],[44,34,43,0],[34,44,55,0],[29,33,45,0],[40,55,33,0],
