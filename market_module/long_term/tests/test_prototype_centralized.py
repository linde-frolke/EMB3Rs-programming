...
# #Simulation for 3 years, given 1 year data
# def test_centralized():
#     print("start test_centralized().............................................")
#     # TEST CENTRALIZED #######################################################################################
#     # DATA
#     gmax = {'gmax': random.randint(100, size=(365, 4)).tolist()}
#
#     lmax = {'lmax': random.randint(100, size=(365, 4)).tolist()}
#
#     cost = {'cost': random.randint(100, size=(365, 4)).tolist()}
#     util = {'util': random.randint(100, size=(365, 4)).tolist()}
#
#     # setup inputs --------------------------------------------
#     input_dict = {'md': 'centralized',
#                   'horizon_basis': 'years',
