...
settings = MarketSettings(prod_diff="co2Emissions", market_design=user_input['md'],
                          horizon_b=user_input['horizon_basis'], 
                          recurr=user_input['recurrence'], data_prof=user_input['data_profile'],
